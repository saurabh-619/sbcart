...
class MenCategories extends StatefulWidget {
  @override
  _MenCategoriesState createState() => _MenCategoriesState();
}
...
class _MenCategoriesState extends State<MenCategories> {
  ...
  getAllMenCategories() async {
    QuerySnapshot snapshot = await categoriesRef
        .where('gender', isEqualTo: 'forhim')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: header(title: 'men', context: context),
      body: RefreshIndicator(
        onRefresh: () {
          return getAllMenCategories();
        },
        child: Container(
